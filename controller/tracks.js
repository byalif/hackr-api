...
exports.uploadTrack = async (req, res) => {
  ...
  console.log(zip);
  const promises = [
    uploadAudio(wavttle, `${process.env.BUCKET}`, req.files[0].buffer),
    uploadAudio(mp3ttle, `${process.env.BUCKET}`, req.files[1].buffer),
    uploadAudio(zip, `${process.env.BUCKET}`, req.files[3].buffer),
    uploadAudio(
      dismp3,
      `${process.env.BUCKET}`,
      req.files[2].buffer,
  ...
  // const wav = await uploadAudio(
  //   wavttle,
  //   `${process.env.BUCKET}`,
  //   req.files[0].buffer
  // );
  // const mp3 = await uploadAudio(
  //   mp3ttle,
  //   `${process.env.BUCKET}`,
  //   req.files[1].buffer
  // );
  // const zipFile = await uploadAudio(
  //   zip,
  //   `${process.env.BUCKET}`,
  //   req.files[3].buffer
  // );

  // const display = await uploadAudio(
  //   dismp3,
  //   `${process.env.BUCKET}`,
  //   req.files[2].buffer,
  //   "audio/mp3"
